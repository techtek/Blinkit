...
:: Let the user know that led 1 is going to be blinked, on the arduino, and display the com and baudrate:  	  
...
:: Test Blink the LED, by sending the u command to the arduino
	...
	echo u> config/arduinocommand.txt
...
:: Let the user know, there is a new Upvote, and blink the Upvote led
    echo u> config/arduinocommand.txt
	start arduinosendcommand.exe  
