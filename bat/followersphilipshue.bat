...
:: Let the user know the Philips Hue is going to be blinked, on the %iphue%  by displaying the text:  	  
	...
	start  C:\blinkit\bat\philipshueblue.exe 
...
:: Display the saved Username and IP of the Philips Hue, and let the user know that the program is starting to look for new Upvotes
	echo.
	echo %White%Preparing BlinkIt, 
	echo Notifications for %Blue%%steemusername%%White% on Philips Hue: %Blue%%iphue%%White% ...	  
	timeout 4  
...
:: Let the user know, there is a new Follower, blink the Philips Hue lights
	start  C:\blinkit\bat\philipshueblue.exe 
	timeout %blinklengthphilipshue%
	start  C:\blinkit\bat\philipshueoff.exe 	
	echo.
