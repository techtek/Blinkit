...
:: Blink the LED, by copying the LED file from the Blinkit folder to the USB flashdrive	with blink.bat
	timeout 6
	call blink.bat 
	echo.
...
:: Let the user know, there is a new Follower, and blink the LED by copying the LED file to the flash drive with blink.bat
	call blink.bat  
