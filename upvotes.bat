...
:: Blink the LED, by copying the LED file from the Blinkit folder to the flashdrive with blink.bat
...
:: Let the user know, there is a new Upvote, and blink the LED by copying the LED file to the flash drive with blink.bat
    call blink.bat  
